...
* **Architecture 100% Autonome :** Fonctionne en Single-Page Application (SPA) native sans dépendance lourde, garantissant des temps de chargement instantanés.
* **Ergonomie Terrain :** Optimisée pour le tactile (tablettes, mobiles) et le desktop avec support des raccourcis et du scanner QR Code.

---

## 🚀 Fonctionnalités Clés

* 📊 **Tableau de bord & KPIs :** Suivi en temps réel des indicateurs critiques, des charges d'équipes et de la météo des chantiers.
* 🛠️ **Gestion des Interventions & Kanban :** Visualisation par statut, gestion des urgences (`P1` à `P4`), historique complet et assignation du personnel.
...
* **Frontend :** HTML5 Semantique, CSS3 Avancé (Variables CSS, Glassmorphism, Animations GPU), Vanilla JavaScript (Zero-dependency).
* **UI/UX :** Responsive Design, CSS Paged Media support, animations par keyframes fluides.
* **Stockage & Sync :** Gestion d'état local et synchronisation multi-utilisateurs.
